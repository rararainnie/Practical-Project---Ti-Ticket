...
function ProfilePage() {
  ...
  if (loading) {
    return <div className="bg-black min-h-screen text-white flex items-center justify-center">กำลังโหลด...</div>;
  }

  if (!currentUser) {
    return <div className="bg-black min-h-screen text-white flex items-center justify-center">กรุณาเข้าสู่ระบบ</div>;
  }
