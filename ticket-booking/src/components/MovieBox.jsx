...
function MovieBox({ image, name, date, time, location, onBuyTickets }) {
  return (
    <div className="mt-3 ml-2 p-2 bg-zinc-900 rounded-3x1 max-w-lg">
      <div className="flex-col">
        <img src={image} alt={name} className="h-[400px] object-cover rounded-3xl" />
        <div className="ml-3 flex flex-col text-center items-center">
          <div>
